...
from roll_witch.dice_bot.input_parser import RegexInputParser
...
class TestRegexInputParser(TestCase):
    ...
    def test_parse_simple_dice(self, dice_count, dice_sides):
        ...
        self.assertEqual(dice_count, spec.dice_count, f"Dice Count in {element} does not match {spec.dice_count}")
        self.assertEqual(dice_sides, spec.dice_sides, f"Dice Sides in {element} does not match {spec.dice_sides}")
        self.assertEqual(0, spec.dice_modifier, f"Dice Modifier in {element} is invalid")
    ...
    def test_parse_simple_dice_with_positive_modifier(self, dice_count, dice_sides, modifier):
        ...
        self.assertEqual(dice_count, spec.dice_count, f"Dice Count in {element} does not match {spec.dice_count}")
        self.assertEqual(dice_sides, spec.dice_sides, f"Dice Sides in {element} does not match {spec.dice_sides}")
        self.assertGreater(spec.dice_modifier, 0, f"Dice Modifier in {element} is invalid")
        self.assertIsNone(spec.target_number, f"Target Number in {element} is invalid")
    ...
    def test_parse_simple_dice_with_negative_modifier(self, dice_count, dice_sides, modifier):
        ...
        self.assertEqual(dice_count, spec.dice_count, f"Dice Count in {element} does not match {spec.dice_count}")
        self.assertEqual(dice_sides, spec.dice_sides, f"Dice Sides in {element} does not match {spec.dice_sides}")
        self.assertEqual(modifier, spec.dice_modifier, f"Dice Modifier in {element} is invalid")
        self.assertIsNone(spec.target_number, f"Target Number in {element} is invalid")
