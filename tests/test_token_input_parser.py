...
from roll_witch.dice_bot.input_parser import TokenInputParser
...
class TestRegexInputParser(TestCase):
    ...
    def test_parse_simple_dice(self, dice_count, dice_sides):
        ...
        self.assertEqual(dice_count, dice_spec.dice_count,
    ...
    def test_parse_lower_target_dice(self, dice_count, dice_sides, target):
        ...
        self.assertEqual(dice_sides, dice_spec.dice_sides,
                         f"Dice Sides in {element} does not match {dice_spec.dice_sides}")
        self.assertEqual(target, target_spec.target_number, f"Target Does not match")
